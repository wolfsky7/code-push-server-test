...
config.development = {
  ...
  db: {
    username: process.env.RDS_USERNAME || "tfuse1",
    password: process.env.RDS_PASSWORD || 'tfuse1',
  ...
  local: {
    ...
    storageDir:"../code-push-data",// process.env.STORAGE_DIR || "/Users/tablee/workspaces/storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://10.0.0.22:3002",
  ...
  jwt: {
    ...
    tokenSecret: process.env.TOKEN_SECRET ||'Gw7xm2qrJ6iV67CtVUvvMTjiqadl4ksvOXqog'
  },
  common: {
    /*
    ...
    dataDir:"../code-push-data",// process.env.DATA_DIR || "/Users/tablee/workspaces/data",
